...
<h3 style="text-align: center;">ĐÂY LÀ THÔNG TIN QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP CƠ QUAN Y TẾ LIÊN LẠC KHI CẦN
    THIẾT ĐỂ PHÒNG CHỐNG DỊCH
    BỆNH TRUYÊN NHIỄM</h3>
<h5 style="text-align: center;">Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể xử lý hình
    sự</h5>
<form:form action="/add" method="post" modelAttribute="medical">
    <table style="width: 90%;margin: 0 auto">
        <tr>
            <td>
                <label for="">Họ tên (ghi chữ IN HOA)</label>
            </td>
        </tr>
        <tr>
            <td>
